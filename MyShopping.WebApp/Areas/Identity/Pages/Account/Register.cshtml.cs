...
namespace MyShoping.WebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                CompanyList = _unitOfWork.CategoryRepos.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                }),
            ...
            if (ModelState.IsValid)
            {
               ...
               // user.PhoneNumber = Input.PhoneNumber;
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.CustomerRole); // Change => CutomerRole
